...
public class User1Controller {
    ...
    @ResponseBody // 요청 메서드의 반환값을 View로 출력하지 않고 응답객체 Response body로 출력.
    @GetMapping("/user1")
    ...
    @ResponseBody
    @PutMapping("/user1")
    public ResponseEntity<User1DTO> modify(@Valid @RequestBody User1DTO user1DTO){ // @RequestBody : 요청 객체 body로 전송되는 JSON 데이터 수신
        log.info("user1DTO:{}",user1DTO);
